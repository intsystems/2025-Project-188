...
\par\smallskip\emph{Консультант:} D.\,D.~Dorin
...
\begin{frame}{Цель исследования}
    ...
    \begin{block}{Задачи}
        \begin{enumerate}
            \item Кластеризовать бассейны по статическим атрибутам
            \item Оценить вклад статических атрибутов через SHAP анализ в работу модели.
