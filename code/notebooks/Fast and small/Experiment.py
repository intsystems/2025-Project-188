...
class Experiment:
    ...
    def prepare_experiment(self, num_load: int = 8) -> None:
        self.logger.warning(
            "Train test split does not calling if dtrain already exists."
        )
    ...
    def make(self, params: Dict[str, Any]) -> None:
        self.prepare_experiment(params["num_load"] if "num_load" in params else None)
