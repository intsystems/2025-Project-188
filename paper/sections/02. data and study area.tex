...
precipitation (\texttt{prcp}), river water level (\texttt{lvl\_sm}), minimum temperature (\texttt{t\_min}), maximum temperature (\texttt{t\_max}), mean temperature (\texttt{t\_mean}), and river discharge (\texttt{q\_mm\_day}).
