...
\todo[inline]{Требуется ли описать каждую из введённых моделей}
\todo[inline]{Поговорить насчёт того, как каждую из моделей адаптировать под данную задачу.}
